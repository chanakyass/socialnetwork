...
@Slf4j
public class CommentServiceIT extends SocialNetworkApplicationIT {
    ...
    @Autowired
    public CommentServiceIT(MockMvc mockMvc, ObjectMapper objectMapper, CommentEditMapper commentEditMapper,
