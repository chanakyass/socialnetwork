...
public class UserServiceIT extends SocialNetworkApplicationIT {
    ...
    @Autowired
    public UserServiceIT(MockMvc mockMvc, UserTestDataFactory userTestDataFactory, UserEditMapper userEditMapper,
