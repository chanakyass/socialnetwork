...
@Slf4j
public class PostServiceIT extends SocialNetworkApplicationIT {
    ...
    @Autowired
    public PostServiceIT(MockMvc mockMvc, ObjectMapper objectMapper, PostEditMapper postEditMapper, PostTestDataFactory postTestDataFactory,
