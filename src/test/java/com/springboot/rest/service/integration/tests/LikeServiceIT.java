...
@Slf4j
public class LikeServiceIT extends SocialNetworkApplicationIT {
    ...
    @Autowired
    public LikeServiceIT(MockMvc mockMvc, ObjectMapper objectMapper, LikeTestDataFactory likeTestDataFactory,
