...
public interface CommentRepos extends JpaRepository<Comment, Long> {
    ...
    Optional<Page<CommentView>> findCommentsByCommentedOn_IdAndParentCommentIsNull(Long postId, Pageable pageable);

    Optional<Page<CommentView>> findCommentsByParentComment_Id(Long parentCommentId, Pageable pageable);
